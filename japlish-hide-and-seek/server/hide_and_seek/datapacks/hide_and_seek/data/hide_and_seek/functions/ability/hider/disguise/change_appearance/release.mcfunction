...
#block_idをminecraft:airに
execute store success storage macro: block_data.error int 1 run data modify entity @e[type=minecraft:block_display,tag=disguise_block,tag=target,limit=1,sort=nearest] block_state.Name set value "minecraft:air"
