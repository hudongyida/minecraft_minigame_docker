...
loot give @s loot hide_and_seek:ability/seeker/attack_bullet
loot give @s loot hide_and_seek:ability/seeker/scan
loot give @s loot hide_and_seek:ability/seeker/fly_seeker