...
execute as @s at @s run function bosses:tech/the_shaman/pattern3/type2/summon/place_chalice with entity @s data

execute as @s at @s run function system:vfx/clock_rotate/init {duration:60, radius:1, distance:1, clock_r:0.4, clock_g:0.4, clock_b:0.9}
...
tag @s remove bosses.the_shaman.pattern3.chalice.type2.marker.uninitialized