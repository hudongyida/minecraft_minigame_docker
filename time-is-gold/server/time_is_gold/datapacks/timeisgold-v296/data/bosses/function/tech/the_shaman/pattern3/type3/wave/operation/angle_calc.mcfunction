...
scoreboard players remove @s bosses.the_shaman.pattern3.chalice.circular_wave.inner_radius 1500
...
rotate @s 0 0
execute at @s run function bosses:tech/the_shaman/pattern3/type3/wave/operation/rotate_marker with entity @s data