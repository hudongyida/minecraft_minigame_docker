...
function bosses:tech/the_shaman/pattern3/type3/wave/operation/angle_calc with entity @s data
execute at @s run function bosses:tech/the_shaman/pattern3/type3/wave/operation/apply_damage with entity @s data
