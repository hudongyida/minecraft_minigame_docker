...
execute as @s at @s run function bosses:tech/the_shaman/pattern3/type4/summon/place_chalice with entity @s data

execute as @s at @s run function system:vfx/clock_rotate/init {duration:60, radius:1, distance:1, clock_r:1.0, clock_g:1.0, clock_b:0.2}
...
tag @s remove bosses.the_shaman.pattern3.chalice.type4.marker.uninitialized