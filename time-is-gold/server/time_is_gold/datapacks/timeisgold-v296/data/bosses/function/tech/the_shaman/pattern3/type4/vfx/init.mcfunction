...
scoreboard players operation @s bosses.the_shaman.pattern3.chalice.area_display_tick %= #30 scoreboardConstant
execute if score @s bosses.the_shaman.pattern3.chalice.area_display_tick matches 0 at @s run function system:vfx/expand_circle/init {range:20, step:10, R:0.66, G:0.66, B:0.05}