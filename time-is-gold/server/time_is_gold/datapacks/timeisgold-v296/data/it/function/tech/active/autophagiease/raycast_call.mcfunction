data modify storage timeisgold:function_api stack append value {type:active, path:autophagiease, initfunction:none, tickfunction:particle, hitfunction:tag_target, endfunction:none,\
