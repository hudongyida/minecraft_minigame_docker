data modify storage timeisgold:function_api stack append value {type:active, path:fragility_perfume, initfunction:none, tickfunction:dusts, hitfunction:none, endfunction:none,\
