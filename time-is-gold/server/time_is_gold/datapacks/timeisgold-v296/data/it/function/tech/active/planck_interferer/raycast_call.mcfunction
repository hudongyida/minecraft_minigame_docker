data modify storage timeisgold:function_api stack append value {type:active, path:planck_interferer, initfunction:none, tickfunction:none, hitfunction:tag_target, endfunction:none,\
