data modify storage timeisgold:function_api stack append value {type:active, path:pyrogel, initfunction:none, tickfunction:none, hitfunction:none, endfunction:place,\
                                                                playerid:0, speed:0.5, hitbox_1:0.15, hitbox_2:0.7, hitbox_3:0.85, wall:1, hitend:0, step:8}
