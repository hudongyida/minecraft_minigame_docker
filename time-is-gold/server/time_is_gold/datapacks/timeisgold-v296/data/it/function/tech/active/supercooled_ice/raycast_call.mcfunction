data modify storage timeisgold:function_api stack append value {type:active, path:supercooled_ice, initfunction:none, tickfunction:test, hitfunction:none, endfunction:place_bomb,\
