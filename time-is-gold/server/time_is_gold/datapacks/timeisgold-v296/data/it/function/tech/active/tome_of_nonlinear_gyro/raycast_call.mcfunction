data modify storage timeisgold:function_api stack append value {type:active, path:tome_of_nonlinear_gyro, initfunction:none, tickfunction:none, hitfunction:none, endfunction:summon_marker,\
