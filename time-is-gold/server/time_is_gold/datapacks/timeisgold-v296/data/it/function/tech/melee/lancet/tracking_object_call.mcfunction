data modify storage timeisgold:function_api stack append value {type:melee, path:lancet, initfunction:none, tickfunction:particle, hitfunction:hit, endfunction:none,\
