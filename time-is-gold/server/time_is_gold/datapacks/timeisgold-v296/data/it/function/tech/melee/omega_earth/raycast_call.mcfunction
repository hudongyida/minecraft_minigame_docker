data modify storage timeisgold:function_api stack append value {type:melee, path:omega_earth, initfunction:none, tickfunction:none, hitfunction:none, endfunction:summon_marker,\
