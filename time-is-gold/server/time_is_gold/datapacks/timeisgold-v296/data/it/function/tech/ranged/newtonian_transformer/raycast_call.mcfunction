data modify storage timeisgold:function_api stack append value {type:ranged, path:newtonian_transformer, initfunction:none, tickfunction:laser, hitfunction:hit, endfunction:none,\
