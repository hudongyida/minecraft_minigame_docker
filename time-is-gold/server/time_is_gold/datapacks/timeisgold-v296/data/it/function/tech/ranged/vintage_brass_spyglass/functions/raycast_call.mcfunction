data modify storage timeisgold:function_api stack append value {type:ranged, path:vintage_brass_spyglass, initfunction:none, tickfunction:laser, hitfunction:hit, endfunction:none,\
