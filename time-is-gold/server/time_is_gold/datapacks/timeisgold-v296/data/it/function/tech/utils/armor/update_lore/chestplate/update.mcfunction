...
item modify entity @s armor.chest it:armor/update_time_defense_stat
scoreboard players operation @s item.utils.armor.chestplate.time_defense_additive = @s item.utils.armor.time_defense_additive
scoreboard players operation @s item.utils.armor.chestplate.time_defense_multiplicative = @s item.utils.armor.time_defense_multiplicative