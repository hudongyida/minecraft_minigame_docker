# 2층의 모든 몬스터 중 하나를 랜덤으로 소환

execute store result score @s monsters.global.summon.randomizer run random value 0..12
...
execute if score @s monsters.global.summon.randomizer matches 8 run function monsters:summon/floor2/specimen_skeleton
execute if score @s monsters.global.summon.randomizer matches 9 run function monsters:summon/floor2/specimen_zombie
execute if score @s monsters.global.summon.randomizer matches 10 run function monsters:summon/floor2/student_a
execute if score @s monsters.global.summon.randomizer matches 11 run function monsters:summon/floor2/student_b
execute if score @s monsters.global.summon.randomizer matches 12 run function monsters:summon/floor2/uu_weaponsmith