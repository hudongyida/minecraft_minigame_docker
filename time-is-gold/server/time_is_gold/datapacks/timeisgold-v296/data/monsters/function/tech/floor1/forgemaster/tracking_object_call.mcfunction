data modify storage timeisgold:function_api stack append value {path:"monsters:tech/floor1/forgemaster", initfunction:none, tickfunction:flame, hitfunction:hit, endfunction:none,\
