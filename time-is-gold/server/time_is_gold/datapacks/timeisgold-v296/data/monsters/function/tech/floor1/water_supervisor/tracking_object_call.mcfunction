data modify storage timeisgold:function_api stack append value {path:"monsters:tech/floor1/water_supervisor", initfunction:none, tickfunction:water, hitfunction:hit, endfunction:none,\
