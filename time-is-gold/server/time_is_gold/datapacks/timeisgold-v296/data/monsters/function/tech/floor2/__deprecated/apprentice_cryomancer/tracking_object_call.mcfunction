data modify storage timeisgold:function_api stack append value {path:"monsters:tech/floor2/apprentice_cryomancer", initfunction:none, tickfunction:snow, hitfunction:hit, endfunction:none,\
