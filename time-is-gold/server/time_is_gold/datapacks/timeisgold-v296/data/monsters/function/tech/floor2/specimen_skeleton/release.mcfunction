...
execute at @s run playsound minecraft:entity.skeleton.hurt hostile @a ~ ~ ~ 0.6 0.6 0
execute at @s run playsound minecraft:entity.skeleton.converted_to_stray hostile @a ~ ~ ~ 0.6 1 0
