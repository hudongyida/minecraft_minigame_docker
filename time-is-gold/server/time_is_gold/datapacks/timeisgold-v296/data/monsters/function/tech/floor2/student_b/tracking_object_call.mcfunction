data modify storage timeisgold:function_api stack append value {path:"monsters:tech/floor2/student_b", initfunction:summon_display, tickfunction:step, endfunction:collision_effect, hitfunction:hit,\
