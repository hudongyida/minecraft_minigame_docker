...
$data modify storage timeisgold:function_api stack append value {value:$(value), monsteruuid:"$(monsteruuid)"}
...
function monsters:tech/global/utils/monster_damage/magic/damage with storage timeisgold:function_api stack[-1]
