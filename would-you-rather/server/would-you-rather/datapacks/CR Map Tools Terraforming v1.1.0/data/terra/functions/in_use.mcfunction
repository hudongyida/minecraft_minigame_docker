...
execute as @a[tag=crmTterraform,nbt={SelectedItem:{id:"minecraft:cat_spawn_egg"}}] if score @s crmTshape matches 0 run title @s actionbar [{"text":"当前形状: ","color":"dark_aqua"},{"text":"圆筒","color":"gold"},{"text":" (换手来切换)","color":"aqua"}]
execute as @a[tag=crmTterraform,nbt={SelectedItem:{id:"minecraft:cat_spawn_egg"}}] if score @s crmTshape matches 1 run title @s actionbar [{"text":"当前形状: ","color":"dark_aqua"},{"text":"小球体","color":"gold"},{"text":" (换手来切换)","color":"aqua"}]
execute as @a[tag=crmTterraform,nbt={SelectedItem:{id:"minecraft:cat_spawn_egg"}}] if score @s crmTshape matches 2 run title @s actionbar [{"text":"当前形状: ","color":"dark_aqua"},{"text":"大球体","color":"gold"},{"text":" (换手来切换)","color":"aqua"}]
...
execute as @a[tag=crmTterraform,nbt={SelectedItem:{id:"minecraft:cave_spider_spawn_egg"}}] run title @s actionbar [{"text":"纹理变化: ","color":"dark_aqua"},{"score":{"objective": "crmTrandom","name":"$random_texture_mod"},"color":"gold"},{"text":" (换手来切换)","color":"aqua"}]
