tellraw @a ["",{"text":"<","bold":true,"color":"dark_aqua"},{"text":"|","color":"aqua"},{"text":"[","bold":true,"color":"dark_aqua"},{"text":"CR 地图工具","color":"aqua"},{"text":"]","bold":true,"color":"dark_aqua"},{"text":"|","color":"aqua"},{"text":">","bold":true,"color":"dark_aqua"},{"text":" Terraforming Pack 已成功安装.","color":"gold"}]
