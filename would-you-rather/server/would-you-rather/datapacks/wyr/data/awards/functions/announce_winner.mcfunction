tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"selector":"@a[scores={fake_awards=0},tag=playing,tag=award_winner]"}] 
...
execute as @a[scores={fake_awards=0},tag=playing,tag=award_winner] at @s if score $points awards matches 2.. run tellraw @s [{"text":"+","color":"green"},{"score":{"objective":"awards","name":"$points"},"color":"green"},{"text":"点数","color":"green"}]
execute as @a[scores={fake_awards=0},tag=playing,tag=award_winner] at @s if score $points awards matches 1 run tellraw @s [{"text":"+","color":"green"},{"score":{"objective":"awards","name":"$points"},"color":"green"},{"text":"点数","color":"green"}]
