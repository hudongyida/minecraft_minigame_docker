...
execute if score $tie number matches 1 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"selector":"@a[scores={fake_points=0},tag=playing]"}]
execute if score $tie number matches 2.. run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"不好意思, 我们有多个赢家. 获奖者是: ","color":"aqua"},{"selector":"@a[scores={fake_points=0},tag=playing]"}]
