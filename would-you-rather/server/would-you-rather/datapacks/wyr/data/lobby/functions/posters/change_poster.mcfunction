...
execute if score $poster poster_time matches 7.. run scoreboard players set $poster poster_time 1
...
execute if score $poster poster_time matches 5 run function lobby:posters/timw
execute if score $poster poster_time matches 6 run function lobby:posters/cr
