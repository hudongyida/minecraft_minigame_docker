...
execute if score $number fast_mode matches 1 run setblock -936 79 -129 oak_wall_sign[facing=north]{Text1:'{"text":"介绍","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"显示:","color":"yellow","bold":true}',Text3:'{"text":"关闭","color":"red"}',Text4:'{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:fast/click_fast"}}'}
execute if score $number fast_mode matches 0 run setblock -936 79 -129 oak_wall_sign[facing=north]{Text1:'{"text":"介绍","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"显示:","color":"yellow","bold":true}',Text3:'{"text":"开启","color":"green"}',Text4:'{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:fast/click_fast"}}'}
