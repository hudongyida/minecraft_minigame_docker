...
setblock -930 79 -131 oak_wall_sign[facing=north]{Text1:'{"text":"次数","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"回合:","color":"yellow","bold":true}',Text3:'{"score":{"objective":"round_criteria","name":"$round"},"color":"gold"}',Text4:'{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:round/click_round"}}'}
##execute if score $round round_criteria matches 1 run setblock -930 79 -131 oak_wall_sign[facing=north]{Text1:'{"text":"次数","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"回合:","color":"gold","bold":true}',Text3:'{"text":"开启","color":"green"}',Text4:'{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:round/click_round"}}'}
