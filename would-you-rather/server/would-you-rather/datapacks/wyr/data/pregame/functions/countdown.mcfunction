...
execute unless score $time startup_timer matches 1..20 run title @a[scores={joinsong=..0},gamemode=adventure] title [{"score":{"objective":"startup_title","name":"$time"},"color":"dark_aqua"},{"text":" 秒","color":"aqua"}]
execute if score $time startup_timer matches 1..20 run title @a[scores={joinsong=..0},gamemode=adventure] title [{"text":"1","color":"dark_aqua"},{"text":" 秒","color":"aqua"}]
title @a[scores={joinsong=..0,ready=0},gamemode=adventure] subtitle [{"text":"加入比赛 . . .","color":"dark_red"}]
title @a[scores={joinsong=..0,ready=1},gamemode=adventure] subtitle [{"text":"直到比赛开始 . . . ","color":"blue"},{"text":"(","color":"gray"},{"score":{"objective":"rplayers","name":"$number"},"color":"white"},{"text":"/","color":"gray"},{"score":{"objective":"nplayers","name":"$number"},"color":"white"},{"text":")","color":"gray"}]
