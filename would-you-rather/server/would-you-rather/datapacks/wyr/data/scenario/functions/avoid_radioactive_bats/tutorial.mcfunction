...
execute if entity @a[tag=in_tutorial,tag=playing,team=arb,scores={tutorial=5}] run title @a[team=arb,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=arb,scores={tutorial=90}] run tellraw @a[team=arb,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"蝙蝠会飞来飞去并击落下激光.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=arb,scores={tutorial=160}] run tellraw @a[team=arb,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"激光会破坏方块.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=arb,scores={tutorial=210}] run tellraw @a[team=arb,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在平台上存活到倒计时结束.","color":"gray"}]
