...
execute if entity @a[tag=in_tutorial,tag=playing,team=bafe,scores={tutorial=5}] run title @a[team=bafe,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=bafe,scores={tutorial=90}] run tellraw @a[team=bafe,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"风扇会在场景开始时开启, 而你会开始漂浮.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=bafe,scores={tutorial=190}] run tellraw @a[team=bafe,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在上升过程中, 如果你撞上了东西, 就会失明几秒.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=bafe,scores={tutorial=270}] run tellraw @a[team=bafe,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在风扇关闭之前到达顶部的绿色粒子处以获胜.","color":"gray"}]
