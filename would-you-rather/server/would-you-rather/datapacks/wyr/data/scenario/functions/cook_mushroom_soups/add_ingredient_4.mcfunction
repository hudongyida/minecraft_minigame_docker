scoreboard players set $number cms_ingre_4 -1000
tag @a[tag=playing,team=cms,gamemode=adventure,nbt={Inventory:[{tag:{cms_item:4}}]}] add cms_has_duplicate
replaceitem entity @a[tag=playing,team=cms] hotbar.3 air
clear @a[tag=playing,team=cms] #minecraft:soup_items{cms_item:4}
...
tag @a[tag=playing,team=cms,gamemode=adventure] add cms_completed_4
