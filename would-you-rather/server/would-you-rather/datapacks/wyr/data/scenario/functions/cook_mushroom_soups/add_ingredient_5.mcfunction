scoreboard players set $number cms_ingre_5 -1000
tag @a[tag=playing,team=cms,gamemode=adventure,nbt={Inventory:[{tag:{cms_item:5}}]}] add cms_has_duplicate
replaceitem entity @a[tag=playing,team=cms] hotbar.4 air
clear @a[tag=playing,team=cms] #minecraft:soup_items{cms_item:5}
...
tag @a[tag=playing,team=cms,gamemode=adventure] add cms_completed_5
