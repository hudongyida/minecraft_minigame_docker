tellraw @a[tag=playing,team=cms] [{"text":"汤已经煮好了! 把它带给顾客!","color":"gold"}]
...
title @a[tag=playing,team=cms,gamemode=adventure,tag=cms_has_soup] title [{"text":"你拿到汤了!","color":"gold"}]
