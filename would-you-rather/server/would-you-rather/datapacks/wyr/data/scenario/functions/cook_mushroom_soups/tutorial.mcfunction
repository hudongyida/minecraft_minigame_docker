...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=5}] run title @a[team=cms,tag=playing,tag=!no_tutorial] subtitle [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=90}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"顾客会点份汤.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=140}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"而你的背包中的玻璃板代表汤的原料.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=210}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"拿着一块玻璃来显示原料的位置.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=280}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"走到掉落形态的蘑菇附近捡起它.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=350}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"另一方面, 农作物需要收获.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=420}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"你一次只能携带一种食材. 拿到后扔到中间的坩埚里.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=550}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"一旦所有原料都配齐, 随机一名玩家将拿到汤.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=630}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"该玩家需要将其交付给客户.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=cms,scores={tutorial=700}] run tellraw @a[team=cms,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在时间用完之前完成并交付三份汤以完成场景.","color":"gray"}]
