...
execute as @a[tag=playing,team=cs,gamemode=adventure] at @s run title @s actionbar [{"text":"你数过的羊: ","color":"white"},{"text":"[","color":"gray","bold":true},{"score":{"objective":"cs_sheep","name":"@s"},"color":"white","bold":false},{"text":"]","color":"gray","bold":true}]
