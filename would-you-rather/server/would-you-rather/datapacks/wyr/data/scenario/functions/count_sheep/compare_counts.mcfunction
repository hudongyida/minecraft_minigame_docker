...
execute if score @s cs_sheep = $sheep cs_sheep run title @s title [{"text":"正确计数!","color":"green"}]
...
execute unless score @s cs_sheep = $sheep cs_sheep run title @s title [{"text":"错误计数.","color":"red"}]
