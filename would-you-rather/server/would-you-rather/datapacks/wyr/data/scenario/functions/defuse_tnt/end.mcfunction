...
tellraw @a[tag=playing,team=dab] [{"text":"正确的排列是: ","color":"gray"},{"selector":"@e[type=area_effect_cloud,tag=dab_code_1,limit=1]"},{"selector":"@e[type=area_effect_cloud,tag=dab_code_2,limit=1]"},{"selector":"@e[type=area_effect_cloud,tag=dab_code_3,limit=1]"}]
