...
execute as @e[type=area_effect_cloud,tag=display_dab_code] at @s run function scenario:defuse_tnt/name_display_code
tellraw @a[tag=playing,team=dab,gamemode=adventure] [{"text":"-----------------\n","color":"dark_gray"},{"text":"你猜是: ","color":"gray"},{"selector":"@e[type=area_effect_cloud,tag=dab_guess_1]"},{"selector":"@e[type=area_effect_cloud,tag=dab_guess_2]"},{"selector":"@e[type=area_effect_cloud,tag=dab_guess_3]"}]
