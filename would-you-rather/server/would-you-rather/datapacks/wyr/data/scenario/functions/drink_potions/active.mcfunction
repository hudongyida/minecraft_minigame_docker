...
execute if score $time ddp_timer matches 270 run tellraw @a[tag=playing,team=ddp] [{"text":"<","color":"red","bold":true},{"text":"女巫","color":"dark_red","bold":false},{"text":">","color":"red","bold":true},{"text":" 我想和你玩个游戏!","color":"gray","bold":false}]
...
execute if score $time ddp_timer matches 330 run tellraw @a[tag=playing,team=ddp] [{"text":"<","color":"red","bold":true},{"text":"女巫","color":"dark_red","bold":false},{"text":">","color":"red","bold":true},{"text":" 我有","color":"gray","bold":false},{"score":{"objective":"ddp_bottles","name":"$d_number"},"color":"dark_red","bold":true},{"text":"瓶药水在桌上.","color":"gray","bold":false}]
...
execute if score $time ddp_timer matches 370 run tellraw @a[tag=playing,team=ddp] [{"text":"<","color":"red","bold":true},{"text":"女巫","color":"dark_red","bold":false},{"text":"> ","color":"red","bold":true},{"score":{"objective":"ddp_bottles","name":"$d_poison"},"color":"dark_red","bold":true},{"text":"会在你喝下时杀死你.","color":"gray","bold":false}]
...
execute if score $time ddp_timer matches 420 run tellraw @a[tag=playing,team=ddp] [{"text":"<","color":"red","bold":true},{"text":"女巫","color":"dark_red","bold":false},{"text":">","color":"red","bold":true},{"text":" 你必须喝下一瓶药水. 祝你好运! HEHEHEHE","color":"gray","bold":false}]
...
execute if score $time ddp_timer matches 1120 unless entity @a[tag=playing,team=ddp,tag=ddp_selecting,scores={ddp_cool=1..},gamemode=adventure] run tellraw @a[tag=playing,team=ddp,gamemode=adventure,tag=ddp_selecting] [{"text":"请现在喝下一瓶药水!","color":"dark_red"}]
