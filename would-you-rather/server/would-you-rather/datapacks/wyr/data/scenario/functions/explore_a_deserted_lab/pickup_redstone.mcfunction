...
execute if entity @s[tag=eadl_has_1,tag=eadl_has_2,tag=!eadl_has_3] run scoreboard players set @s eadl_3 3
execute if entity @s[tag=eadl_has_1,tag=eadl_has_2,tag=!eadl_has_3] run tag @s add eadl_has_3

execute if entity @s[tag=eadl_has_1,tag=!eadl_has_2] run scoreboard players set @s eadl_2 3
execute if entity @s[tag=eadl_has_1,tag=!eadl_has_2] run tag @s add eadl_has_2

execute if entity @s[tag=!eadl_has_1] run scoreboard players set @s eadl_1 3
