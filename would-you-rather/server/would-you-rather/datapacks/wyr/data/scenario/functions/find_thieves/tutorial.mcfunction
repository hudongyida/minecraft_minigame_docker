...
execute if entity @a[tag=in_tutorial,tag=playing,team=ft,scores={tutorial=5}] run title @a[team=ft,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ft,scores={tutorial=90}] run tellraw @a[team=ft,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"玩家头颅会出现在你的物品栏中. 头颅会显示小偷模样.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ft,scores={tutorial=180}] run tellraw @a[team=ft,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"为了清晰地查看头颅, 丢出头颅. 它会暂时出现在你的面前.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ft,scores={tutorial=290}] run tellraw @a[team=ft,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"将该玩家头颅与地图中某处的市民匹配.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ft,scores={tutorial=360}] run tellraw @a[team=ft,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"打那个人以确认他们是否是小偷.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ft,scores={tutorial=430}] run tellraw @a[team=ft,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在时间耗尽之前完成这一过程重复三次.","color":"gray"}]
