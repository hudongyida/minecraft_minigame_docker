...
execute as @a[tag=playing,team=gf,gamemode=adventure] at @s run title @s actionbar [{"text":"目标l: ","color":"aqua","bold":false},{"text":"[","color":"blue","bold":false},{"score":{"objective":"gf_points","name":"@s"},"color":"yellow","bold":true},{"text":"/","color":"blue","bold":false},{"text":"30","color":"yellow","bold":true},{"text":"]","color":"blue","bold":false}]
