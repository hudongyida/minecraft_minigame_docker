...
execute if entity @a[tag=in_tutorial,tag=playing,team=gf,scores={tutorial=5}] run title @a[team=gf,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=gf,scores={tutorial=90}] run tellraw @a[team=gf,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"用你的钓鱼竿钓鱼.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=gf,scores={tutorial=150}] run tellraw @a[team=gf,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"钓到不同的鱼会得到不同的点数.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=gf,scores={tutorial=210}] run tellraw @a[team=gf,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"记住, 只有在开阔的水域里才能钓到宝藏.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=gf,scores={tutorial=290}] run tellraw @a[team=gf,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"你必须在时间结束前获得30分来赢得比赛.","color":"#e2e2e2"}]
