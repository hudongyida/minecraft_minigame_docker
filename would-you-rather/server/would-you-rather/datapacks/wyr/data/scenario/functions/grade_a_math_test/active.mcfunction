...
tellraw @a[team=gamt,tag=playing,scores={gamt_true=1..}] {"text":"你的答案是: \"正确\"","color":"dark_green"}
...
tellraw @a[team=gamt,tag=playing,scores={gamt_untrue=1..}] {"text":"你的答案是: \"错误\"","color":"dark_red"}
...
execute if score $time gamt_timer matches 60 run title @a[tag=playing,team=gamt] title [{"text":"正确 ","color":"green"},{"text":"或者","color":"light_purple"},{"text":" 错误","color":"red"}]
...
execute if score $time gamt_timer matches -20 if score $number gamt_false matches 0 run title @a[team=gamt,scores={gamt_answer=0},gamemode=adventure] title {"text":"正确!","color":"dark_green","underlined":true}
execute if score $time gamt_timer matches -20 if score $number gamt_false matches 1 run title @a[team=gamt,scores={gamt_answer=1},gamemode=adventure] title {"text":"错误!","color":"dark_green","underlined":true}

execute if score $time gamt_timer matches -20 if score $number gamt_false matches 0 run title @a[team=gamt,scores={gamt_answer=1},gamemode=adventure] title {"text":"正确!","color":"dark_red","underlined":true}
execute if score $time gamt_timer matches -20 if score $number gamt_false matches 1 run title @a[team=gamt,scores={gamt_answer=0},gamemode=adventure] title {"text":"错误!","color":"dark_red","underlined":true}
...
execute as @a[tag=playing,team=gamt,gamemode=adventure] at @s run title @s actionbar [{"text":"正确: ","color":"green","bold":false},{"text":"[","color":"dark_green","bold":true},{"score":{"objective":"gamt_tally_c","name":"@s"},"color":"green","bold":false},{"text":"/10","color":"green","bold":false},{"text":"]","color":"dark_green","bold":true},{"text":"  |  ","color":"light_purple","bold":true},{"text":"错误: ","color":"red","bold":false},{"text":"[","color":"dark_red","bold":true},{"score":{"objective":"gamt_tally_i","name":"@s"},"color":"red","bold":false},{"text":"/2","color":"red","bold":false},{"text":"]","color":"dark_red","bold":true}]
