...
replaceitem entity @a[team=hcm,tag=playing] hotbar.0 bow{Unbreakable:1b,HideFlags:63,display:{Name:'[{"text":"Bow","color":"gold","italic":false}]'}}
replaceitem entity @a[team=hcm,tag=playing] hotbar.8 arrow{display:{Name:'[{"text":"Arrow","color":"gray","italic":false}]'}} 15
