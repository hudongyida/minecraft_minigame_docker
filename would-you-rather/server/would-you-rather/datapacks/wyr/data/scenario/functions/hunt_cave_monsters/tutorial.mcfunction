...
execute if entity @a[tag=in_tutorial,tag=playing,team=hcm,scores={tutorial=5}] run title @a[team=hcm,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=hcm,scores={tutorial=90}] run tellraw @a[team=hcm,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"用你的弓箭射击空中的怪物.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=hcm,scores={tutorial=150}] run tellraw @a[team=hcm,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"你的箭是有限的. 但是, 你每次射完都会自动补充.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=hcm,scores={tutorial=230}] run tellraw @a[team=hcm,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"你杀死怪物会给你积分. 可以通过射杀那些更难被击中的怪物来获得更多积分.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=hcm,scores={tutorial=330}] run tellraw @a[team=hcm,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在时间用完之前获得 25 分即可获胜.","color":"#e2e2e2"}]
