...
execute if entity @a[tag=in_tutorial,tag=playing,team=ol,scores={tutorial=5}] run title @a[team=ol,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ol,scores={tutorial=90}] run tellraw @a[team=ol,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"你将从这里出发. 拼命向洞穴出口逃跑.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ol,scores={tutorial=180}] run tellraw @a[team=ol,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"岩浆将水平地从洞穴深处涌出.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ol,scores={tutorial=250}] run tellraw @a[team=ol,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"活着到达掩体以完成场景.","color":"gray"}]
