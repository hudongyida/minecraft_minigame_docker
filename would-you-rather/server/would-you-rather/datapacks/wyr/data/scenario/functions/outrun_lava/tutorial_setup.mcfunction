tag @a[team=ol,tag=playing] add in_tutorial
gamemode spectator @a[team=ol]
title @a[team=ol] times 5 40 5
scoreboard players set @a[team=ol] tutorial 0
kill @e[type=armor_stand,tag=ol_tutorial]
summon armor_stand 23997 76 -5 {Invisible:1b,Small:1b,Invulnerable:1b,Marker:1b,Tags:["ol_tutorial","tutorial_marker"],Rotation:[205f,20f]}
function scenario:outrun_lava/tutorial
