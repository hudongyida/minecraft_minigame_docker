...
scoreboard objectives add ptasv_seconds dummy {"text":"剩余时间","color":"white","bold":true}
...
##
summon minecraft:area_effect_cloud 37985 77.5 20 {Duration:100000,CustomNameVisible:1b,Tags:["ptasv_die"],CustomName:'[{"text":"跳跃提升","color":"green","bold":true}]'}
summon minecraft:area_effect_cloud 38014 95.5 16 {Duration:100000,CustomNameVisible:1b,Tags:["ptasv_die"],CustomName:'[{"text":"飘浮","color":"white","bold":true}]'}
