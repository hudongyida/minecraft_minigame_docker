...
execute if entity @a[tag=in_tutorial,tag=playing,team=ptasv,scores={tutorial=5}] run title @a[team=ptasv,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ptasv,scores={tutorial=90}] run tellraw @a[team=ptasv,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"跳上平台, 在地图中不断前进.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ptasv,scores={tutorial=150}] run tellraw @a[team=ptasv,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"有些平台会来回移动.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ptasv,scores={tutorial=210}] run tellraw @a[team=ptasv,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"混凝土块会给你药水效果.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=ptasv,scores={tutorial=270}] run tellraw @a[team=ptasv,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在死亡之前或倒计时归零之前到达终点以完成场景.","color":"#e2e2e2"}]
