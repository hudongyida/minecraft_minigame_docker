...
execute if entity @a[tag=in_tutorial,tag=playing,team=placeholder,scores={tutorial=5}] run title @a[team=placeholder,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=placeholder,scores={tutorial=90}] run tellraw @a[team=placeholder,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"如果其中两个数据为零, 你将开始凋零直至死亡.","color":"#e2e2e2"}]
