...
execute if score $rand pd_random matches 0 run scoreboard objectives add pd_seconds dummy {"text":"剩余时间","color":"blue","bold":true}
execute if score $rand pd_random matches 1 run scoreboard objectives add pd_seconds dummy {"text":"剩余时间","color":"red","bold":true}
