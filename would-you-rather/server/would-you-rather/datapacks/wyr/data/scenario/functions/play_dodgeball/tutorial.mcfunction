...
execute if entity @a[tag=in_tutorial,tag=playing,team=pd,scores={tutorial=5}] run title @a[team=pd,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=pd,scores={tutorial=90}] run tellraw @a[team=pd,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"潜影贝会从上方向你发射子弹.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=pd,scores={tutorial=150}] run tellraw @a[team=pd,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在白色圆圈的范围内跑来跑去避免被击中.","color":"#e2e2e2"}]
