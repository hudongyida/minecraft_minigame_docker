...
execute if score $action_time pgs_timer matches 60 run title @a[tag=playing,team=pgs,tag=!pgs_completed_action] title [{"text":"赶快!","color":"red"}]
...
execute if entity @e[type=area_effect_cloud,tag=pgs_action,tag=!pgs_has_location] run title @a[tag=playing,team=pgs,gamemode=adventure] actionbar [{"text":"动作: ","color":"dark_aqua"},{"selector":"@e[type=area_effect_cloud,tag=pgs_action]"}]
execute if entity @e[type=area_effect_cloud,tag=pgs_action,tag=pgs_has_location] run title @a[tag=playing,team=pgs,gamemode=adventure] actionbar [{"text":"动作: ","color":"dark_aqua"},{"selector":"@e[type=area_effect_cloud,tag=pgs_action]"},{"text":" 地点: ","color":"dark_aqua"},{"selector":"@e[type=area_effect_cloud,tag=pgs_location]"}]
