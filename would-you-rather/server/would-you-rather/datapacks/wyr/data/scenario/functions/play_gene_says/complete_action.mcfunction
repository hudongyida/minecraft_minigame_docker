...
execute if score $says pgs_timer matches 1 run tellraw @s {"text":"动作完成!","color":"green","italic":true}
execute if score $says pgs_timer matches 0 run tellraw @s {"text":"错误动作完成!","color":"red","italic":true}
replaceitem entity @s armor.chest leather_chestplate
clear @s
