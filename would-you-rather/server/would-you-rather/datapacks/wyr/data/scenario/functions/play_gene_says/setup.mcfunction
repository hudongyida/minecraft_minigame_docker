...
summon area_effect_cloud 27036 68 -18 {Duration:100000,Tags:["pgs_die"],CustomNameVisible:1b,CustomName:'[{"text":"浴室 ","color":"gray"}]'}
summon area_effect_cloud 27035 68 -8 {Duration:100000,Tags:["pgs_die"],CustomNameVisible:1b,CustomName:'[{"text":"办公室","color":"dark_gray"}]'}
summon area_effect_cloud 27027 68 -17 {Duration:100000,Tags:["pgs_die"],CustomNameVisible:1b,CustomName:'[{"text":"厨房","color":"white"}]'}
...
bossbar add minecraft:play_gene_says/time [{"text":"完成操作的剩余时间","color":"aqua"}]
