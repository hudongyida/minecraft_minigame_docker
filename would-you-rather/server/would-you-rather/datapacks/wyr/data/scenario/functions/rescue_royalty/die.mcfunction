...
execute if entity @s[nbt={Inventory:[{id:"minecraft:tripwire_hook"}]}] run summon item ~ ~ ~ {Motion:[0.0d,0.2d,0.0d],Item:{id:"minecraft:tripwire_hook",Count:1b,tag:{HideFlags:63,Enchantments:[{id:"s",lvl:1}],display:{Name:'[{"text":"塔钥匙","color":"yellow","italic":false}]'}}},Tags:["rap_need_movement"]}
