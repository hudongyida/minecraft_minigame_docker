...
replaceitem entity @a[tag=playing,team=rap,gamemode=adventure] hotbar.4 minecraft:splash_potion{CustomPotionEffects:[{Id:12,Duration:200,Amplifier:3}],CustomPotionColor:14981690,display:{Name:'{"text":"快速抗火药水","color":"#e49a3a","italic":false}'}}
replaceitem entity @a[tag=playing,team=rap,gamemode=adventure] hotbar.5 minecraft:splash_potion{CustomPotionEffects:[{Id:12,Duration:200,Amplifier:3}],CustomPotionColor:14981690,display:{Name:'{"text":"快速抗火药水","color":"#e49a3a","italic":false}'}}
replaceitem entity @a[tag=playing,team=rap,gamemode=adventure] hotbar.6 minecraft:splash_potion{CustomPotionEffects:[{Id:12,Duration:200,Amplifier:3}],CustomPotionColor:14981690,display:{Name:'{"text":"快速抗火药水","color":"#e49a3a","italic":false}'}}
...
tellraw @a[team=rap] [{"text":"提醒: ","color":"green","bold":true},{"text":"这个场景使用了无CD点击PvP.","color":"gray","bold":false}]