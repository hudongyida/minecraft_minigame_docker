...
execute if score $number rab_bar matches ..299 run title @a[team=rab,nbt={SelectedItem:{tag:{rab_melee:1}}},gamemode=adventure] subtitle {"text":"尽可能隐藏此武器.","color":"yellow"}
...
execute unless block 15945 64 0 chiseled_stone_bricks if entity @e[type=armor_stand,tag=rab_gem] run title @a[x=15953,y=59,z=0,distance=..6,tag=playing,team=rab,gamemode=adventure] subtitle [{"text":"右键点击宝石!","color":"aqua"}]

execute as @a[tag=playing,team=rab,nbt={Inventory:[{id:"minecraft:player_head",tag:{rab_gem:1}}]},tag=!rab_hold_gem,gamemode=adventure] at @s if entity @e[tag=rab_gem] run title @a[tag=playing,team=rab,gamemode=adventure] title [{"text":"上卡车!","color":"gold"}]
...
##tasks:
execute if score $number rab_bar matches ..299 run title @a[tag=playing,team=rab,gamemode=adventure,scores={rab_y=6900..}] actionbar [{"text":"当前任务: ","color":"dark_aqua"},{"text":"抢劫, 然后到达银行后面的电梯.","color":"aqua"}]
execute if entity @e[type=armor_stand,tag=rab_gem] run title @a[tag=playing,team=rab,gamemode=adventure,scores={rab_y=..6800}] actionbar [{"text":"当前任务: ","color":"dark_aqua"},{"text":"跑到金库, 把里面的宝石拿过来.","color":"aqua"}]
execute if score $number rab_bar matches 300.. if entity @e[type=armor_stand,tag=rab_gem] run title @a[tag=playing,team=rab,gamemode=adventure,scores={rab_y=6900..}] actionbar [{"text":"当前任务: ","color":"dark_aqua"},{"text":"前往银行后面的电梯.","color":"aqua"}]
execute if score $number rab_bar matches 300.. unless entity @e[type=armor_stand,tag=rab_gem] if score $gem rab_timer matches 0 run title @a[tag=playing,team=rab,gamemode=adventure] actionbar [{"text":"当前任务: ","color":"dark_aqua"},{"text":"护送宝石到卡车上.","color":"aqua"}]
execute if score $number rab_bar matches 300.. unless entity @e[type=armor_stand,tag=rab_gem] if score $gem rab_timer matches 1 run title @a[tag=playing,team=rab,gamemode=adventure] actionbar [{"text":"当前任务: ","color":"dark_aqua"},{"text":"上车.","color":"aqua"}]
