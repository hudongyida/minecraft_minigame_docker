...
execute as @a[tag=playing,team=saru,gamemode=adventure,scores={saru_lives=2..}] at @s run title @s actionbar [{"text":"[","color":"gold","bold":true},{"score":{"objective":"saru_lives","name":"@s"},"color":"red","bold":false},{"text":"条命","color":"red","bold":false},{"text":"]","color":"gold","bold":true}]
execute as @a[tag=playing,team=saru,gamemode=adventure,scores={saru_lives=1}] at @s run title @s actionbar [{"text":"[","color":"gold","bold":true},{"score":{"objective":"saru_lives","name":"@s"},"color":"red","bold":false},{"text":"条命","color":"red","bold":false},{"text":"]","color":"gold","bold":true}]
