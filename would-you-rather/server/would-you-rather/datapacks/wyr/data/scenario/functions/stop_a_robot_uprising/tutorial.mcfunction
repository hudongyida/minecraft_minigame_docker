...
execute if entity @a[tag=in_tutorial,tag=playing,team=saru,scores={tutorial=5}] run title @a[team=saru,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=saru,scores={tutorial=90}] run tellraw @a[team=saru,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"所有生物和玩家都是瞬秒.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=saru,scores={tutorial=130}] run tellraw @a[team=saru,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"当你死后, 你会在工厂外重生.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=saru,scores={tutorial=190}] run tellraw @a[team=saru,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"你的复活次数有限, 这将显示在你的操作栏上.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=saru,scores={tutorial=270}] run tellraw @a[team=saru,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"有几种类型的敌方机器人. 有些会摧毁附近的箭, 或在玩家附近爆炸, 或向你射击.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=saru,scores={tutorial=370}] run tellraw @a[team=saru,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"弓箭手机器人在自身周围会有警告粒子.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=saru,scores={tutorial=430}] run tellraw @a[team=saru,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"你的目标是在时间耗尽或生命耗尽前杀死三个发光的 \"指挥官\" 机器人.","color":"#e2e2e2"}]
