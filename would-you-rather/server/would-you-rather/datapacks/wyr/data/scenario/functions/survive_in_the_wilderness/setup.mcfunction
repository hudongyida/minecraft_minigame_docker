...
bossbar add survive_in_the_wilderness:campfire {"text":"剩余的篝火热量","color":"gold","bold":true}
...
scoreboard objectives add sitw_seconds dummy {"text":"剩余时间","color":"dark_red","bold":true}
