...
execute if entity @a[tag=in_tutorial,tag=playing,team=wat,scores={tutorial=5}] run title @a[team=wat,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=wat,scores={tutorial=90}] run tellraw @a[team=wat,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"顺着铁栅栏走并跳过间隙的到终点..","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=wat,scores={tutorial=160}] run tellraw @a[team=wat,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"跌下去会导致你死亡.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=wat,scores={tutorial=210}] run tellraw @a[team=wat,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"在时间用完之前, 到达跑酷终点以完成场景.","color":"gray"}]
