...
execute if entity @a[tag=in_tutorial,tag=playing,team=wiaaf,scores={tutorial=5}] run title @a[team=wiaaf,tag=playing,tag=!no_tutorial] title [{"text":"| ","color":"dark_green"},{"text":"教程","color":"green","bold":true},{"text":" |","color":"dark_green"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=wiaaf,scores={tutorial=90}] run tellraw @a[team=wiaaf,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"铁砧会从上方落下.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=wiaaf,scores={tutorial=150}] run tellraw @a[team=wiaaf,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"尽力奔跑, 直到倒计时结束.","color":"#e2e2e2"}]
