...
execute if entity @a[tag=playing,scores={scenario_sel=1}] run tellraw @a[tag=playing] [{"text":"\n| ","color":"aqua"},{"selector":"@e[type=area_effect_cloud,tag=chosen,tag=blue_select]"},{"text":" | ","color":"aqua"},{"text":" \n尝试玩家: ","color":"aqua"},{"selector":"@a[scores={scenario_sel=1},tag=playing]"},{"text":"\n隐藏点数获得: ","color":"aqua"},{"text":"+","color":"green"},{"score":{"objective":"points_for_win","name":"@r[scores={scenario_sel=1},tag=playing]"},"color":"green"}]
...
execute if entity @a[tag=playing,scores={scenario_sel=2}] run tellraw @a[tag=playing] [{"text":"\n| ","color":"#fff8aa"},{"selector":"@e[type=area_effect_cloud,tag=chosen,tag=yellow_select]"},{"text":" | ","color":"#fff8aa"},{"text":" \n尝试玩家: ","color":"#fff8aa"},{"selector":"@a[scores={scenario_sel=2},tag=playing]"},{"text":"\n隐藏点数获得: ","color":"#fff8aa"},{"text":"+","color":"green"},{"score":{"objective":"points_for_win","name":"@r[scores={scenario_sel=2},tag=playing]"},"color":"green"}]
