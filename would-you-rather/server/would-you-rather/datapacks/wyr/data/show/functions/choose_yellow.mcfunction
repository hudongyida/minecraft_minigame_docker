tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"selector":"@a[team=select]"},{"text":" 选择了:","color":"aqua"},{"text":" \"","color":"yellow"},{"selector":"@e[tag=yellow_select]"},{"text":"\"","color":"yellow"}]
