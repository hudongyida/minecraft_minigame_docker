...
title @a[team=wyr,tag=playing] actionbar [{"text":"\"","color":"blue"},{"selector":"@e[tag=blue_select]"},{"text":"\"","color":"blue"},{"text":" 或是 ","color":"green"},{"text":"\"","color":"yellow"},{"selector":"@e[tag=yellow_select]"},{"text":"\"","color":"yellow"}]