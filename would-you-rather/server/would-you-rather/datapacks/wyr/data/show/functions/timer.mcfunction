...
execute if score $time showstart matches 2 run tellraw @a[tag=playing] [{"text":"<","color":"blue"},{"text":"技术员","color":"aqua"},{"text":">","color":"blue"},{"text":" 还有五秒就上台了!","color":"aqua"}]
...
execute if score $time showstart matches 140 run tellraw @a [{"text":"<","color":"dark_gray"},{"text":"播音员","color":"gray"},{"text":">","color":"dark_gray"},{"text":" 女士们先生们, 掌声欢迎你们的主持人 . . . 吉恩!","color":"aqua"}]
...
##
execute if score $time showstart matches 320 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":">","color":"blue"},{"text":" 欢迎收看 '你宁愿' !","color":"aqua"}] 
...
execute if score $time showstart matches 520 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":">","color":"blue"},{"text":" 是时候问问题了 . . .","color":"aqua"}] 
...
execute if score $time showstart matches 550 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":">","color":"blue"},{"text":" 你!","color":"aqua"}] 
...
execute if score $time showstart matches 580 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":">","color":"blue"},{"text":" 宁!","color":"aqua"}] 
...
execute if score $time showstart matches 610 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":">","color":"blue"},{"text":" 愿!","color":"aqua"}] 
...
execute if score $time showstart matches 750 if score $criteria round matches 1.. run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"你宁愿,","color":"aqua"}]
...
execute if score $time showstart matches 800 run tellraw @a {"text":"或是","color":"green"}
...
execute if score $time showstart matches 860 run tellraw @a[tag=playing] [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"慎重考虑你的抉择.","color":"aqua"}]
...
##execute if score $time showstart matches 1305 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"时间到! ","color":"aqua"},{"selector":"@a[team=select]"},{"text":" 正在走上舞台做出自己的选择!","color":"aqua"}]
...
##execute if score $time showstart matches 1406..1606 run title @a[team=select] subtitle [{"text":"\"","color":"blue"},{"selector":"@e[tag=blue_select]"},{"text":"\"","color":"blue"},{"text":" 或是 ","color":"green"},{"text":"\"","color":"yellow"},{"selector":"@e[tag=yellow_select]"},{"text":"\"","color":"yellow"}]
##
...
execute if score $time showstart matches 1351 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"我们把它带到战场上去!","color":"aqua"}]
...
execute if score $time showstart matches 5001 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"我们开始吧!","color":"aqua"}] 
...
execute if score $time showstart matches 6121 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"赢家是 . . .","color":"aqua"}] 
...
execute if score $time showstart matches 6280 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"恭喜 ","color":"aqua"},{"selector":"@a[scores={fake_points=0},tag=playing]"},{"text":"!","color":"aqua"}] 
...
execute if score $time showstart matches 6350 run tellraw @a [{"text":"<","color":"blue"},{"text":"吉恩","color":"aqua"},{"text":"> ","color":"blue"},{"text":"我们下期节目 '你宁愿' 见!","color":"aqua"}] 
...
execute if score $time showstart matches 8080 run tellraw @a[tag=playing] [{"text":"场景跳过.","color":"red","bold":true}]
